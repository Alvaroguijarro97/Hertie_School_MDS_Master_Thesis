...
# Find the full range of values for workers including both actual values and predictions
full_range <- range(c(250000,manizales_dataset_subset$workers.geih, quantile(test_data_man$predicted_workers,0.25)))
...
# Find the full range of values for workers including both actual values and predictions
full_range <- range(c(manizales_dataset_subset$workers.geih, 180000,260000))
