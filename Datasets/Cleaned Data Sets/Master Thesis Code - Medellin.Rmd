...
```{r}
# Find the full range of values for workers including both actual values and predictions
full_range <- range(c(medellin_dataset_subset$workers.geih, 1600000))
...
# For OLS models
model_var_summary$OLS <- extract_lm_vars(stepwise_model_med)
...
write_xlsx(model_summaries, path = "medellin_results.xlsx")

```

```{r export plot}
# Open a PNG graphics device
png("medellin_results.png", width=600, height=500)  # Adjust 'width' and 'height' as needed
