...
# For OLS models
model_var_summary$OLS <- extract_lm_vars(stepwise_model_bog)
...
write_xlsx(model_summaries, path = "bogota_results.xlsx")
```

```{r export plot}
# Open a PNG graphics device
png("bogota_results.png", width=600, height=500)  # Adjust 'width' and 'height' as needed
